class ScrumBoard
	...
	scrum_DataToColumn1(){var scrum_from=this.scrum_PendingColumn;var scrum_to="ScrumBoard_column_pending";var scrum_task_showmore="ScrumBoard_readmore ScrumBoard_showmore1";var scrum_task_hidden="ScrumBoard_task ScrumBoard_hidden1";var scrum_task_normal="ScrumBoard_task";var scrum_counter=-1;var tempRef=this;function loop(){if(scrum_counter<scrum_from.length-1){scrum_counter=scrum_counter+1;try{var finalClassName=scrum_task_normal;if(scrum_counter>=20){finalClassName = scrum_task_hidden;}document.getElementsByClassName(scrum_to)[0].innerHTML = document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='" + finalClassName + "'><div class='scrum_task_details'>"+scrum_from[scrum_counter][1]+"</div><div class='ScrumBoard_task_project'>"+scrum_from[scrum_counter][0]+"</div></div>";if(scrum_counter==20){document.getElementsByClassName(scrum_to)[0].innerHTML=document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='"+scrum_task_showmore+"' onclick='for(var i=0;i<document.getElementsByClassName(\""+scrum_task_hidden+"\").length;i++){document.getElementsByClassName(\""+scrum_task_hidden+"\")[i].style.display=\"block\";}document.getElementsByClassName(\""+scrum_task_showmore+"\")[0].style.display=\"none\";'>"+tempRef.STRING_SHOWMORE +"</div>";}}catch(err){}setTimeout(loop,tempRef.addingDelay);}else{tempRef.scrum_DataToColumn2();}}loop();}

	// FUNCTION THAT WILL ADD THE TASKS TO THE SECOND COLUMN (IN DEVELOPMENT)
	scrum_DataToColumn2(){var scrum_from=this.scrum_DevelopmentColumn;var scrum_to="ScrumBoard_column_development";var scrum_task_showmore="ScrumBoard_readmore ScrumBoard_showmore2";var scrum_task_hidden="ScrumBoard_task ScrumBoard_hidden2";var scrum_task_normal="ScrumBoard_task";var scrum_counter=-1;var tempRef=this;function loop(){if(scrum_counter<scrum_from.length-1){scrum_counter=scrum_counter+1;try{var finalClassName=scrum_task_normal;if(scrum_counter>=20){finalClassName = scrum_task_hidden;}document.getElementsByClassName(scrum_to)[0].innerHTML = document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='" + finalClassName + "'><div class='scrum_task_details'>"+scrum_from[scrum_counter][1]+"</div><div class='ScrumBoard_task_project'>"+scrum_from[scrum_counter][0]+"</div></div>";if(scrum_counter==20){document.getElementsByClassName(scrum_to)[0].innerHTML=document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='"+scrum_task_showmore+"' onclick='for(var i=0;i<document.getElementsByClassName(\""+scrum_task_hidden+"\").length;i++){document.getElementsByClassName(\""+scrum_task_hidden+"\")[i].style.display=\"block\";}document.getElementsByClassName(\""+scrum_task_showmore+"\")[0].style.display=\"none\";'>"+tempRef.STRING_SHOWMORE +"</div>";}}catch(err){}setTimeout(loop,tempRef.addingDelay);}else{tempRef.scrum_DataToColumn3();}}loop();}

	// FUNCTION THAT WILL ADD THE TASKS TO THE THIRTH COLUMN (READY FOR TESTING)
	scrum_DataToColumn3(){var scrum_from=this.scrum_ReadyForTestingColumn;var scrum_to="ScrumBoard_column_test";var scrum_task_showmore="ScrumBoard_readmore ScrumBoard_showmore3";var scrum_task_hidden="ScrumBoard_task ScrumBoard_hidden3";var scrum_task_normal="ScrumBoard_task";var scrum_counter=-1;var tempRef=this;function loop(){if(scrum_counter<scrum_from.length-1){scrum_counter=scrum_counter+1;try{var finalClassName=scrum_task_normal;if(scrum_counter>=20){finalClassName = scrum_task_hidden;}document.getElementsByClassName(scrum_to)[0].innerHTML = document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='" + finalClassName + "'><div class='scrum_task_details'>"+scrum_from[scrum_counter][1]+"</div><div class='ScrumBoard_task_project'>"+scrum_from[scrum_counter][0]+"</div></div>";if(scrum_counter==20){document.getElementsByClassName(scrum_to)[0].innerHTML=document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='"+scrum_task_showmore+"' onclick='for(var i=0;i<document.getElementsByClassName(\""+scrum_task_hidden+"\").length;i++){document.getElementsByClassName(\""+scrum_task_hidden+"\")[i].style.display=\"block\";}document.getElementsByClassName(\""+scrum_task_showmore+"\")[0].style.display=\"none\";'>"+tempRef.STRING_SHOWMORE +"</div>";}}catch(err){}setTimeout(loop,tempRef.addingDelay);}else{tempRef.scrum_DataToColumn4();}}loop();}

	// FUNCTION THAT WILL ADD THE TASKS TO THE FOURTH COLUMN (DONE)
	scrum_DataToColumn4(){var scrum_from=this.scrum_DoneColumn;var scrum_to="ScrumBoard_column_done";var scrum_task_showmore="ScrumBoard_readmore ScrumBoard_showmore4";var scrum_task_hidden="ScrumBoard_task ScrumBoard_hidden4";var scrum_task_normal="ScrumBoard_task";var scrum_counter=-1;var tempRef=this;function loop(){if(scrum_counter<scrum_from.length-1){scrum_counter=scrum_counter+1;try{var finalClassName=scrum_task_normal;if(scrum_counter>=20){finalClassName = scrum_task_hidden;}document.getElementsByClassName(scrum_to)[0].innerHTML = document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='" + finalClassName + "'><div class='scrum_task_details'>"+scrum_from[scrum_counter][1]+"</div><div class='ScrumBoard_task_project'>"+scrum_from[scrum_counter][0]+"</div></div>";if(scrum_counter==20){document.getElementsByClassName(scrum_to)[0].innerHTML=document.getElementsByClassName(scrum_to)[0].innerHTML+"<div class='"+scrum_task_showmore+"' onclick='for(var i=0;i<document.getElementsByClassName(\""+scrum_task_hidden+"\").length;i++){document.getElementsByClassName(\""+scrum_task_hidden+"\")[i].style.display=\"block\";}document.getElementsByClassName(\""+scrum_task_showmore+"\")[0].style.display=\"none\";'>"+tempRef.STRING_SHOWMORE+"</div>";}}catch(err){}setTimeout(loop,tempRef.addingDelay);}else{if (tempRef.runWhenDone!=null){tempRef.runWhenDone();}}}loop();}
